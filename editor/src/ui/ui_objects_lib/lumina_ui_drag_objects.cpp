...
namespace lumina_editor
{
	...
	)
	{
		...
		result_x_drag = ImGui::DragFloat(("##" + label + "drag_x").c_str(), &buffer[0]);
		ImGui::SameLine();
		...
		// Render Drag Y
		result_y_drag = ImGui::DragFloat(("##" + label + "drag_y").c_str(), &buffer[1]);
		ImGui::SameLine();
		...
		// Render Drag Z
		result_z_drag = ImGui::DragFloat(("##" + label + "drag_z").c_str(), &buffer[2]);
		ImGui::SameLine();
	...
	)
	{
		...
		// Render Drag W
		result_w_drag = ImGui::DragFloat(("##" + label + "drag_w").c_str(), &buffer[3]);
		ImGui::SameLine();
	...
	)
	{
		...
		// Render Drag W
		result_z_drag = ImGui::DragFloat(("##" + label + "drag_w").c_str(), &buffer[3]);
