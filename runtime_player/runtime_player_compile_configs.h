...
#define LUMINA_RUNTIME_PLAYER_BIN_DIR LUMINA_RUNTIME_PLAYER_PROJ_EXECUTED_DIR "bin"
...
#define LUMINA_RUNTIME_PLAYER_ASSEMBLIES_DIR LUMINA_RUNTIME_PLAYER_BIN_DIR "/"
